        ...
        <div className="container-fluid">
          <div className="banner_col">
            ...
            <div className="banner-img">
              ...
              width={"100%"} height={"100%"} layout='responsive' placeholder="blur" alt="work station" priority={true}
              blurDataURL="https://res.cloudinary.com/dcfzux5xq/image/upload/q_auto/v1662729599/Techdots/images/work-station_fjaqoc.svg"
              />
            </div>
          </div>
        </div>
          ...
          <div className={styles.grid_block}>
            <div>
              <div className={styles.icon}>
                <Image src="https://res.cloudinary.com/dcfzux5xq/image/upload/q_auto/v1662729600/Techdots/images/project-icon_hjgqzw.svg"
            ...
            <div>
            <div className={styles.icon}>
                <Image src="https://res.cloudinary.com/dcfzux5xq/image/upload/q_auto/v1662729602/Techdots/images/team-icon_vc0rui.svg"
      ...
      <section className={styles.services}>
        <div className="container">
          ...
          <div className="row align-items-center col-reverse-md">
            ...
            <div className="col-12 col-sm-12 col-lg-6 col-xl-6 col-xxl-6">
              <Image src="https://res.cloudinary.com/dcfzux5xq/image/upload/q_auto/v1662729610/Techdots/images/implementation_fglhgw.svg"
                width={400} height={400} alt="Implement software without consuming a large share of your organization"
                placeholder="blur"
                blurDataURL="https://res.cloudinary.com/dcfzux5xq/image/upload/q_auto/v1662729610/Techdots/images/implementation_fglhgw.svg"
              />
            </div>
          </div>
          ...
          <div className="row align-items-center col-reverse-md">
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
              <Image
                src="https://res.cloudinary.com/dcfzux5xq/image/upload/q_auto/v1662729603/Techdots/images/consultation_tuhnem.svg"
                width={324} height={324} alt="What caursgrab users’ attention"
                placeholder="blur"
                blurDataURL="https://res.cloudinary.com/dcfzux5xq/image/upload/q_auto/v1662729603/Techdots/images/consultation_tuhnem.svg"
              />
            </div>
          </div>
